...
<body>
  <video src="img/video.mp4" autoplay loop muted id="vidFondo"></video>
  ...
  <div class="contenedor">
    ...
    <div class="colContenido" id="contenedor">
  ...
  <script type="text/javascript" src="js/mostrar_mas.js"></script>
